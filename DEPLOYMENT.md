...
### Ошибка Telegram "terminated by other getUpdates"

Это нормально при перезапуске контейнеров. Telegram бот может работать только в одном инстансе. Ошибка исчезнет сама через 1-2 минуты.
